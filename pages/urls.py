...
from .views import AboutUsView, contact_form, HomePageView, LoginView, devView, Random_AceView, Random_Ace_GainView, Random_Ace_LoseView, Random_Ace_GainMView, Random_Ace_LoseMView, Who_am_IView
